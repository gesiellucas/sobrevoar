<template>
  <div class="min-h-screen bg-gray-50">
    <!-- Header -->
    <DashboardHeader title="Sobre Voar" :user="authStore.user" :is-admin="authStore.isAdmin" @logout="handleLogout" />

    <!-- Main content -->
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <!-- Create Trip Form -->
      <div class="mb-8">
        <CreateTripCard ref="createTripCardRef" :is-admin="authStore.isAdmin" @submit="handleCreateTrip"
      ...
      <section class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="bg-white rounded-t-lg border border-b-0 border-gray-200">
            <div class="flex items-center justify-between px-4 py-2">
              <nav class="flex" aria-label="Tabs">
                <button v-for="tab in statusTabs" :key="tab.value" @click="setActiveTab(tab.value)" :class="[
              ...
              <!-- Search -->
              <div class="relative">
                <input v-model="searchValue" type="text" placeholder="Buscar por ID..." :disabled="tripStore.loading"
                ...
                <button v-if="searchValue && !tripStore.loading" @click="clearSearch"
                ...
                <!-- Loading spinner -->
                <div v-if="tripStore.loading" class="absolute right-2 top-1/2 -translate-y-1/2">
          ...
          <!-- Table -->
          <TripTable :data="filteredTripRequests" :loading="tripStore.loading" :pagination="tripStore.pagination"
